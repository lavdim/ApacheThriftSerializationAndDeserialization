...
public class Employee implements org.apache.thrift.TBase<Employee, Employee._Fields>, java.io.Serializable, Cloneable, Comparable<Employee> {
  ...
  private static final org.apache.thrift.protocol.TField SURNNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("surnname", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public String surnname; // required
  public int age; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    NAME((short)1, "name"),
    SURNNAME((short)2, "surnname"),
    AGE((short)3, "age");
  ...
  static {
    ...
    tmpMap.put(_Fields.SURNNAME, new org.apache.thrift.meta_data.FieldMetaData("surnname", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Employee(Employee other) {
    ...
    if (other.isSetSurnname()) {
      this.surnname = other.surnname;
    }
    this.age = other.age;
  }
  ...
  public Employee setSurnname(String surnname) {
    this.surnname = surnname;
    return this;
  }

  public void unsetSurnname() {
    this.surnname = null;
  }

  /** Returns true if field surnname is set (has been assigned a value) and false otherwise */
  public boolean isSetSurnname() {
    return this.surnname != null;
  }

  public void setSurnnameIsSet(boolean value) {
    if (!value) {
      this.surnname = null;
    }
  }
  ...
  public boolean equals(Employee that) {
    ...
    boolean this_present_surnname = true && this.isSetSurnname();
    boolean that_present_surnname = true && that.isSetSurnname();
    if (this_present_surnname || that_present_surnname) {
      if (!(this_present_surnname && that_present_surnname))
        return false;
      if (!this.surnname.equals(that.surnname))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_surnname = true && (isSetSurnname());
    list.add(present_surnname);
    if (present_surnname)
      list.add(surnname);
  ...
  public int compareTo(Employee other) {
    ...
    lastComparison = Boolean.valueOf(isSetSurnname()).compareTo(other.isSetSurnname());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSurnname()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.surnname, other.surnname);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (!first) sb.append(", ");
    sb.append("surnname:");
    if (this.surnname == null) {
      sb.append("null");
    } else {
      sb.append(this.surnname);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("age:");
  ...
  private static class EmployeeStandardScheme extends StandardScheme<Employee> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Employee struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SURNNAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.surnname = iprot.readString();
              struct.setSurnnameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Employee struct) throws org.apache.thrift.TException {
      ...
      if (struct.surnname != null) {
        oprot.writeFieldBegin(SURNNAME_FIELD_DESC);
        oprot.writeString(struct.surnname);
        oprot.writeFieldEnd();
      }
